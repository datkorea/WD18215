    ...
    <div className="Content">
      <div>
        ...
        <div className="text">
          ...
          <b className="text2">Section 1.10.33 of "de Finibus Bonorum et Malorum"</b>
          <p>
            {" "}
          ...
          <h2 className="text2">Section</h2>
          <p>
            1.10.33 "At vero eos et accusamus et iusto odio dignissimos ducimus
